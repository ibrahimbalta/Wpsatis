    ...
    <div className="min-h-screen bg-[#0a0f1d] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-700 relative z-10">
        <div className="flex flex-col items-center mb-8">
           ...
           <h1 className="text-3xl font-black text-white tracking-tight">Wpsatis'a Giriş Yap</h1>
           <p className="text-slate-500 font-medium text-sm mt-2 text-center">
             Satışlarınızı hızlandırmak için hesabınıza erişin.
           </p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-slate-600 font-medium italic">
          Turn incoming messages into sales with one click.
        </p>
      </div>
    </div>
  );
